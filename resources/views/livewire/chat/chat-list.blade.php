...
coversationElement = document.getElementById('coversation-'+query);
...
conversationElement.scrollIntoView({'behavior':'smooth'});
    ...
    "
    class="flex flex-col transition-all h-full overflow">
    ...
    <main class="overflow overflow-hidden grow h-full relative" style="contain: content;">
        <ul class="p-2 grid w-full space-y-2">
            ...
            <li
                ...
                class="py-3 hover:bg-blue-50 rounded-2xl dark:hover:bg-gray-700 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 {{$conversation->id==$selectedConversation?->id ? 'bg-gray-100/70':''}}">
                <a href="#" class="shrink-0">
                    <x-avatar src="https://picsum.photos/200"></x-avatar>
                </a>
